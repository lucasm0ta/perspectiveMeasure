...
I = imread("~/UnB/PVC/IMGS/2-3.jpeg");
imshow(I)
...
line1 = createLine([0 111], [492 56]);
line2 = createLine([379 444], [713 474]);
drawLine(line1, args{:})
drawLine(line2, args{:})
...
line1 = createLine([491 56], [1163 178]);
line2 = createLine([100 643], [1145 441]);
drawLine(line1, args{:})
drawLine(line2, args{:})
...
edenEdge = [974, 264, 974, 471];
lucasEdge = [295, 254, 295, 595];
