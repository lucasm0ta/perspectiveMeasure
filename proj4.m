...
I = imread("~/UnB/PVC/IMGS/2-2.jpeg");
imshow(I)
...
line1 = createLine([0 51], [293 25]);
line2 = createLine([171 423], [528 450]);
drawLine(line1, args{:})
drawLine(line2, args{:})
...
line1 = createLine([294 25], [956 162]);
line2 = createLine([0 609], [1146 365]);
drawLine(line1, args{:})
drawLine(line2, args{:})
...
edenEdge = [766, 241, 766, 441];
lucasEdge = [85, 227, 85, 580];
